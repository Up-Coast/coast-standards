---
name: write-a-guide
description: House style for guides, the documentation that tells a reader what something is, how it works, how to use it and how to change it. Load it BEFORE writing a guide, even when the request never says "guide": judge by what the document is for, not by the word "document". Covers internal docs for a team (dashboards, pipelines, scripts, tools, processes), product help for users, READMEs and handover docs, wherever they will live (a wiki, a README, a help page, a docs site). Trigger phrases: "document how this works", "write the docs", "documentation for", "write up how this works", "explain how this works so the team can use it", "README", "how-to", "user guide", "help article", "handover", "instructions for the team". Not for requirements, specs or briefs written for another agent or session, plans, task lists, decision records, findings or audits: "put this in a document" is not a request for a guide. Not for research write-ups or reports, and not for marketing copy. For developer documentation (installation, configuration, CLI and settings references, release notes, rule documents), also load write-developer-documentation; where the two differ, that skill wins for developer documentation.
---
