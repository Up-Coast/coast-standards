...
(not itemised on a primary source). Built so far: E0.1 through E2.5, the whole of phases E0–E2 (section 6 marks
each row DONE as it lands, with what was found on the way); phase E3 — Coast's
customer-facing half — and E4 are design until their rows say otherwise.
