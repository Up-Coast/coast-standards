...
<!-- Starter CLAUDE.md block for a new Up Coast project. Copy into the project's CLAUDE.md,
     fill the blanks, delete these comments. -->

## Standing rules (read before any work)

This project follows the Up Coast standards repo:
`~/Documents/Claude/Code/up-coast-standards/` (GitHub: Up-Coast/up-coast-standards).
